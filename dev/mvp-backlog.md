...
- [VIS-51 — Define and implement asset storage, access and reuse rights](https://linear.app/visamp/issue/VIS-51/define-and-implement-asset-storage-access-and-reuse-rights) — Unassigned.
...
| D27 / D27a | [VIS-51 — Define and implement asset storage, access and reuse rights](https://linear.app/visamp/issue/VIS-51/define-and-implement-asset-storage-access-and-reuse-rights) | High | Unassigned | Todo | — |
| D27 / D27b | [VIS-52 — Build asset library discovery, selection and upload UI](https://linear.app/visamp/issue/VIS-52/build-asset-library-discovery-selection-and-upload-ui) | High | Unassigned | Backlog | [VIS-51](https://linear.app/visamp/issue/VIS-51/define-and-implement-asset-storage-access-and-reuse-rights) |
| D27 / D27c | [VIS-53 — Load assets in the renderer and preserve access in forks](https://linear.app/visamp/issue/VIS-53/load-assets-in-the-renderer-and-preserve-access-in-forks) | High | Unassigned | Backlog | [VIS-51](https://linear.app/visamp/issue/VIS-51/define-and-implement-asset-storage-access-and-reuse-rights) |
| D28 | [VIS-55 — Handle missing assets and enforce the 24-hour repair window](https://linear.app/visamp/issue/VIS-55/handle-missing-assets-and-enforce-the-24-hour-repair-window) | High | Unassigned | Backlog | [VIS-51](https://linear.app/visamp/issue/VIS-51/define-and-implement-asset-storage-access-and-reuse-rights), [VIS-53](https://linear.app/visamp/issue/VIS-53/load-assets-in-the-renderer-and-preserve-access-in-forks) |
